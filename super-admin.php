...
$foundationPages=['overview','employees','employee-add','employee-edit','employee-view','settings','departments','designations','roles','account','system','shifts','roster','holidays','attendance','manual_attendance','attendance_history','monthly','leaves','leave_history','leave_policy','balances','attendance_settings','shift_defaults','time_policies','biometric_integration','attendance_dashboard','attendance_requests','daily_work_status','punch_log','attendance_exceptions','company_calendar','devices','mapping','sync','raw_logs'];
